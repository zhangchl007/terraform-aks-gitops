...
variable "use_existing_acr" {
  description = "Set true when referencing an existing ACR; false to create a new registry"
  type        = bool
  default     = false
}

variable "new_acr_name" {
  description = "Name to assign when creating a new ACR (optional; autogenerated if empty)"
  type        = string
  default     = ""
}
